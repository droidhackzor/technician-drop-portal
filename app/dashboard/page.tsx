        ...
        <div style={styles.grid}>
          <section
            style={{
              ...styles.card,
              ...styles.leftColumn,
              ...(mobileTab === 'new' ? styles.mobileSectionVisible : styles.mobileSectionHidden),
            }}
          >
          ...
          <section
            style={{
              ...styles.card,
              ...styles.rightColumn,
              ...(mobileTab === 'recent' ? styles.mobileSectionVisible : styles.mobileSectionHidden),
            }}
          >
            ...
            <div style={styles.desktopTableOnly}>
...
if (typeof window !== 'undefined') {
  const styleId = 'tdp-mobile-dashboard-overrides';
  if (!document.getElementById(styleId)) {
    ...
    style.innerHTML = `
      ...
      @media (max-width: 1024px) {
        body .tdp-mobile-tabs {
          display: flex !important;
        }
        body .tdp-dashboard-grid {
        ...
        body .tdp-desktop-table {
          display: none !important;
        }
        body .tdp-mobile-list {
